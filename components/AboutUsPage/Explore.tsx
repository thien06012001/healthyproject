  ...
  return (
    <div className="grid grid-col bg-lime-50">
        ...
        <div className="flex flex-col m-auto p-20">
          <div className="w-[591px] h-[308px]">
            <p className="text-[55px] font-extrabold">
              Explore Nutritious <br /> and <br /> Delicious Recipes
            </p>
          </div>
          ...
          <div className="flex flex-col py-8 mt-6">
            ...
            <div className="px-16 mt-10">
              <p className="text-[24px]">
                {" "}
                Starting sharing healthy recipes <br />
                Improving By The Inspiring Healthy Living <br />
                Making healthy choice to stay looking fine
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-row py-10">
        ...
        <div className="bg-[#A1C94CE5] opacity-90 w-[406px] h-[164px] m-auto flex flex-row">
        ...
        <div className="bg-[#CAD4DB] w-[406px] h-[164px] m-auto flex flex-row">
