...
import ProductFeed_Salad from "../../../components/ProductPage/OverWeight/ProductFeed_Salad";
...
function Salad({ overweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Over Weight Salad</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Salad overweights={overweights} />
        </div>
      </main>
    </div>
  );
