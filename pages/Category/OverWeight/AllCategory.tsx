...
import ProductFeed from "../../../components/ProductPage/OverWeight/ProductFeed";
...
function Category({ overweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title>All Over Weight Products</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed overweights={overweights} />
        </div>
      </main>
    </div>
  );
