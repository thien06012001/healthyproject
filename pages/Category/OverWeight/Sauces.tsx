...
import ProductFeed_Sauces from "../../../components/ProductPage/OverWeight/ProductFeed_Sauces";
...
function Sauces({ overweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Over Weight Sauces</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Sauces overweights={overweights} />
        </div>
      </main>
    </div>
  );
