...
import ProductFeed_Meat from "../../../components/ProductPage/OverWeight/ProductFeed_Meat";
...
function Meat({ overweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Over Weight Meat</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Meat overweights={overweights} />
        </div>
      </main>
    </div>
  );
