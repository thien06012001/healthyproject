...
import ProductFeed_Drinks from "../../../components/ProductPage/OverWeight/ProductFeed_Drinks";
...
function Drinks({ overweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Over Weight Drinks</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Drinks overweights={overweights} />
        </div>
      </main>
    </div>
  );
