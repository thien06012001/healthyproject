...
import ProductFeed_Meat from "../../../components/ProductPage/Obese/ProductFeed_Meat";
    ...
    <div className="h-full bg-lime-50 flex flex-col ">
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Meat obeses={obeses} />
        </div>
      </main>
    </div>
  );
