...
import ProductFeed_Sauces from "../../../components/ProductPage/Obese/ProductFeed_Sauces";
...
function Sauces({ obeses }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Obese Sauces</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Sauces obeses={obeses} />
        </div>
      </main>
    </div>
  );
