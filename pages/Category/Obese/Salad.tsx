...
import ProductFeed_Salad from "../../../components/ProductPage/Obese/ProductFeed_Salad";
...
function Salad({ obeses }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Obese Salad</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Salad obeses={obeses} />
        </div>
      </main>
    </div>
  );
