...
import ProductFeed_Drinks from "../../../components/ProductPage/UnderWeight/ProductFeed_Drinks";
...
function Drinks({ underweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Under Weight Drinks</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Drinks underweights={underweights} />
        </div>
      </main>
    </div>
  );
