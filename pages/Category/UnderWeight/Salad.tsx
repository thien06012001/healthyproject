...
import ProductFeed_Salad from "../../../components/ProductPage/UnderWeight/ProductFeed_Salad";
...
function Salad({ underweights }: Props) {
    ...
    <div className="h-full bg-lime-50 flex flex-col ">
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Salad underweights={underweights} />
        </div>
      </main>
    </div>
  );
