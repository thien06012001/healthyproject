...
import ProductFeed_Snacks from "../../../components/ProductPage/UnderWeight/ProductFeed_Snacks";
...
function Snacks({ underweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Under Weight Snacks</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Snacks underweights={underweights} />
        </div>
      </main>
    </div>
  );
