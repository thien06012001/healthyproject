...
import ProductFeed_Starch from "../../../components/ProductPage/NormalWeight/ProductFeed_Starch";
...
function Starch({ normalweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Normal Weight Starch</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Starch normalweights={normalweights} />
        </div>
      </main>
    </div>
  );
