...
import ProductFeed_Snacks from '../../../components/NormalWeight/ProductFeed_Snacks'
...
function Snacks({normalweights}: Props) {
    const router = useRouter()
  return (
    <div className='h-full bg-lime-50 flex flex-col '>
        <Head>
          <title> Normal Weight Snacks</title>
        ...
        <main className='flex flex-row'>
            ...
            <div className='m-auto w-[80%]'>
                <ProductFeed_Snacks normalweights={normalweights}/>
            </div>
