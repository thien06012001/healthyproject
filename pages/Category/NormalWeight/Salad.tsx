...
import ProductFeed_Salad from "../../../components/ProductPage/NormalWeight/ProductFeed_Salad";
...
function Salad({ normalweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Normal Weight Salad</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Salad normalweights={normalweights} />
        </div>
      </main>
    </div>
  );
