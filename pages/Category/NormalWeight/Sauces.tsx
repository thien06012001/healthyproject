...
import ProductFeed_Sauces from "../../../components/ProductPage/NormalWeight/ProductFeed_Sauces";
...
function Sauces({ normalweights }: Props) {
  const router = useRouter();
  return (
    <div className="h-full bg-lime-50 flex flex-col ">
      <Head>
        <title> Normal Weight Sauces</title>
      ...
      <main className="flex flex-row">
        ...
        <div className="m-auto w-[80%]">
          <ProductFeed_Sauces normalweights={normalweights} />
        </div>
      </main>
    </div>
  );
