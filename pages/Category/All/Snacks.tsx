...
function Snacks({normalweights, underweights, overweights, obeses}: Props) {
    ...
    <div className='h-full bg-lime-50 flex flex-col '>
        ...
        <main className='flex flex-row'>
            ...
            <div className='m-auto w-[80%]'>
                <ProductFeed_Snacks underweights={underweights} normalweights={normalweights} overweights={overweights} obeses={obeses}/>
            </div>
