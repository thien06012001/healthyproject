...
import ProductFeed_Salad from '../../../components/AllWeight/ProductFeed_Salad'
...
function Salad({normalweights, underweights, overweights, obeses}: Props) {
    const router = useRouter()
  return (
    <div className='h-full bg-lime-50 flex flex-col '>
         <Head>
          <title>All Salad</title>
        ...
        <main className='flex flex-row'>
            ...
            <div className='m-auto w-[80%]'>
                <ProductFeed_Salad underweights={underweights} normalweights={normalweights} overweights={overweights} obeses={obeses}/>
            </div>
